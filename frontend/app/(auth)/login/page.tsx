        ...
        {step === "credentials" ? (
          <Card className="border-slate-700 bg-slate-900/60 backdrop-blur-sm">
            <CardHeader className="space-y-1">
              ...
              <CardTitle className="text-2xl text-center text-white">SecureChain Rotate</CardTitle>
            ...
            <CardFooter className="flex flex-col">
              <div className="text-sm text-slate-400 text-center mt-2">Protected by SecureChain Rotate Advanced Security</div>
            </CardFooter>
          </Card>
        ) : (
          <Card className="border-slate-700 bg-slate-900/60 backdrop-blur-sm">
